'''
Author: zyy
Date: 2022-12-15 20:59:09
LastEditTime: 2022-12-16 20:22:09
Description: 
'''
...
result_path = "./lab/lab_ahash/result"
threshold = 10
...
def lab_ahash():
    ...
    with open(label_path, 'r', encoding='utf8') as f:
        ...
        # 对label中的相似对和不相似对文本进行simhash计算
            ...
            hash1 =  image_hash.aHash(img_path1)
            hash2 =  image_hash.aHash(img_path2)
