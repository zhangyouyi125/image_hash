'''
Author: zyy
Date: 2022-12-16 20:26:10
LastEditTime: 2022-12-16 20:26:10
Description: 
'''
...
result_path = "./lab/lab_whash/result"
threshold = 10
...
def lab_whash():
    ...
    with open(label_path, 'r', encoding='utf8') as f:
        ...
        # 对label中的相似对和不相似对文本进行simhash计算
            ...
            hash1 =  image_hash.wHash(img_path1)
            hash2 =  image_hash.wHash(img_path2)
