'''
Author: zyy
Date: 2022-12-16 20:18:29
LastEditTime: 2022-12-16 20:21:59
Description: 
'''
...
result_path = "./lab/lab_dhash/result"
threshold = 10
...
def lab_dhash():
    ...
    with open(label_path, 'r', encoding='utf8') as f:
        ...
        # 对label中的相似对和不相似对文本进行simhash计算
            ...
            hash1 =  image_hash.dHash(img_path1)
            hash2 =  image_hash.dHash(img_path2)
